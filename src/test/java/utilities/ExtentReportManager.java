...
public class ExtentReportManager implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		HashMap<String, String> data = (HashMap<String, String>) result.getParameters()[0]; // Assuming your test method
																							// has parameters
		String testData = "Email: " + data.get("Email") + ", Password: " + data.get("Password") + ", Credentials: "
